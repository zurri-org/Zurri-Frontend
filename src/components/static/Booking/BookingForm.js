...
class Booking extends React.Component {
  ...
  getBookedOutDates () {
    const { bookings } = this.props.hotel
  ...
  confirmProposedData () {
    ...
    this.setState({
      proposedBooking: {
        ...this.state.proposedBooking,
        days,
        totalPrice: days * hotel.dailyRate,
        hotel
      },
      modal: {
        open: true
    ...
    return (
      <div className='booking'>
        ...
        <p className='booking-note-title'>
          People are interested into this hotel
        </p>
        <p className='booking-note-text'>
          More than 500 people checked this hotel in last month.
        </p>
        <BookingModal
          open={this.state.modal.open}
          closeModal={this.cancelConfirmation}
          booking={this.state.proposedBooking}
          confirmModal={this.reserveHotel}
          errors={this.state.errors}
          hotelPrice={hotel.dailyRate}
        />
      </div>
    )
  }
